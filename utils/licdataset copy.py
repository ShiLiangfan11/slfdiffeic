...
from file import load_file_list
from image import center_crop_arr, augment, random_crop_arr
...
if __name__ == "__main__":
    # 配置
    file_list = "/home/dongnan/SLF/NVC/DiffEIC-main/datalists/train.list"
    out_size = 256
    crop_type = "random"
    use_hflip = True
    use_rot = True
