...
def process(
    ...
    bpp,ref = model.apply_condition_compress(control, stream_path, height, width)
    cond = {
...
def parse_args() -> Namespace:
    ...
    parser.add_argument("--ckpt_lc", default='weight/1_2_16/lc.ckpt', type=str, help="checkpoint path of lfgcm and control module")
    ...
    parser.add_argument("--output", type=str, default='results_16/')
